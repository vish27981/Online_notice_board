...
?>
<h2 align="center"><b><u>Update Password</u></b></h2><br><br>
<form align="center" method="post">
	...
	<div class="row">
		...
		<div class="col-sm-5">
		<input type="password" name="op" class="form-control"/></div><br><br>
	</div>
	
	<div class="row">
		<div class="col-sm-4">Enter Your New Password</div>
		<div class="col-sm-5">
		<input type="password" name="np" class="form-control"/></div><br><br>
	</div>
	
	<div class="row">
		<div class="col-sm-4">Enter Your Confirm Password</div>
		<div class="col-sm-5">
		<input type="password" name="cp" class="form-control"/></div><br><br>
	</div>
